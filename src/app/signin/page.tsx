    ...
    return <div className="flex h-screen w-screen justify-center items-center">
        <div className="w-[380px] pb-12 px-5 border-[0.5px] border-[#A3A3A3] border-opacity-50 rounded-lg">
            ...
            <InputBox onBlur={(e) => {
                ...
                }} label="Username" inputType="text" placeholder="shyshy17.0" />
            <InputBox onBlur={(e) => {
            ...
            }} label={`${loading ? "" : "Sign in"}`} icon={loading ? <Loading /> : <RightArrow />} />
            <div className="mt-4 flex justify-end text-sm">
                Don't have an account?<span onClick={() => {
                    router.push("/signup")
                }} className="ml-1 cursor-pointer underline transition-all duration-75">Sign Up</span>
            </div>
        </div>
